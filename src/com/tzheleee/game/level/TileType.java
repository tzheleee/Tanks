...
public enum TileType {
    ...
    UP_LEFT_EAGLE(6), UP_RIGHT_EAGLE(7), DOWN_LEFT_EAGLE(8), DOWN_RIGHT_EAGLE(9),
    UP_LEFT_DEAD_EAGLE(10), UP_RIGHT_DEAD_EAGLE(11), DOWN_LEFT_DEAD_EAGLE(12), DOWN_RIGHT_DEAD_EAGLE(13);
