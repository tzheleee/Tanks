...
import com.tzheleee.game.level.TileType;
import com.tzheleee.graphics.Sprite;
import com.tzheleee.graphics.SpriteSheet;
...
public class Bullet {
    ...
    public enum BulletHeading {
        ...
        B_EAST(21 * Player.SPRITE_SCALE + Player.SPRITE_SCALE / 2, 6 * Player.SPRITE_SCALE + 4,
                Player.SPRITE_SCALE / 2, 1 * Player.SPRITE_SCALE / 2),
        B_SOUTH(21 * Player.SPRITE_SCALE, 6 * Player.SPRITE_SCALE + 4, Player.SPRITE_SCALE / 2,
                1 * Player.SPRITE_SCALE / 2),
        B_WEST(20 * Player.SPRITE_SCALE + Player.SPRITE_SCALE / 2, 6 * Player.SPRITE_SCALE + 4,
                Player.SPRITE_SCALE / 2, 1 * Player.SPRITE_SCALE / 2);
